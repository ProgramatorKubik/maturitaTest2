<?php
// source: C:\wamp64\www\projects\NETTE\tests/../app/config/config.neon 
// source: C:\wamp64\www\projects\NETTE\tests/../app/config/config.local.neon 

class Container_28c8d164e9 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'Nette\Application\IPresenter' => [['application.1', 'application.2']],
			'NetteModule\ErrorPresenter' => [1 => ['application.1']],
			'NetteModule\MicroPresenter' => [1 => ['application.2']],
		...
		'tags' => [
			'inject' => ['application.1' => true, 'application.2' => true],
			'nette.presenter' => [
				'application.1' => 'NetteModule\ErrorPresenter',
				'application.2' => 'NetteModule\MicroPresenter',
			],
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\wamp64\www\projects\NETTE\tests',
			'wwwDir' => 'C:\wamp64\www\projects\NETTE\tests',
			'debugMode' => false,
			'productionMode' => true,
			'consoleMode' => false,
			'tempDir' => 'C:\wamp64\www\projects\NETTE\tests/../temp',
		];
	}
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\wamp64\www\projects\NETTE\tests/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\wamp64\www\projects\NETTE\tests/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_28c8d164e9 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\wamp64\www\projects\NETTE\tests/../temp/cache/latte');
